...
"""
            ...
            try:
                ...
                msg["Subject"] = f"Cyberprotek Inquiry - {service}"
                msg["From"] = "cyberprotek.info@gmail.com"
                msg["To"] = "cyberprotek.info@gmail.com"

                server = smtplib.SMTP("smtp.gmail.com", 587)
                server.starttls()

                server.login(
                    "cyberprotek.info@gmail.com",
                    "hhgo aaki pyrn paos"
                )
